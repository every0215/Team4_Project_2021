...
<body>
	...
	<form name="myForm" method="post" enctype="multipart/form-data">
		...
		<label class="t1">商品名稱:</label> <input type="text" name="productName"
			required="required"><br> <br> <label class="t1">公司名稱:</label>
		<!--        		<input type="text" name="companyName" required="required"> -->
		<input type="text" name="cName" readonly="readonly"
			value='${company.companyName}' required="required" /> <br>
		<br> <label class="t1">商品存貨:</label> <input type="text"
			name="productStuck" required="required"> <br>
		<br> <label class="t1">商品價格:</label> <input type="text"
			name="productPrice" required="required"> <br> <br>
		<label class="t1">商品類別:</label> <select style="width: 185px"
			id="DropDownList1" class="t1" name="productType" required="required">
		...
		</select> <br> <br> <label class="t1">商品說明:</label>
		<textarea style="resize: none; width: 600px; height: 200px;"
			name="productDescript"></textarea>
		<br>
		<br> <label class="t1">商品狀態:</label> <input type="radio" id="on"
			name="status" value="1" checked> <label for="on">上架</label>
		<input type="radio" id="off" name=status value="0"> <label
			for="off">下架</label> <br>
		<br> <label class="t1" for="">商品圖片:</label> <input
			id="image_input" readonly="readonly" type=file name="productimage">
		<br>
