...
<body>
	<script
		src="https://cpwebassets.codepen.io/assets/editor/iframe/iframeConsoleRunner-7f4d47902dc785f30dedcac9c996b9f31d4dfcc33567cc48f0431bc918c2bf05.js"></script>
	<script
						...
						<div class="row">
							...
							<div class="container col-md-10">
								<div class="row">
										...
										<div class="modal__container">
											<div class="modal__content">
												<table id="myTable" style="text-align: center;">
													...
													<thead >
														<tr>
															<td id="ticketOrderId" >票券名稱</td>
															<td id="eventName" >訂單編號</td>
															<td id="totalCost" >總金額</td>
															<td id="#">付款狀態</td>
															<td id="ticketOrderDetailList">票券明細</td>
													...
													<tbody >
														...
														<tr>
															...
															<td>未付款</td>
															<td>444444444</td>
															<td id="opener"><input type='button' value='詳細明細'/></td>
														</tr>
									...
									<div class="col-xs-4">
										<div id="memberCreditCardListDiv"></div>
									</div>
								</div>
							</div>
