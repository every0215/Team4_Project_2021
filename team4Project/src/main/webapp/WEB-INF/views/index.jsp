...
<!-- Theme color -->
<link id="switcher" href="css/theme-color/orange-theme.css"
	rel="stylesheet">
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade in active" id="men">
										<ul class="aa-product-catg">
											...
											<li>
												<figure>
													<a class="aa-product-img" href="#"><img class="imga"
														src="img/man/polo-shirt-2.png" alt="polo shirt img"></a>
													<a class="aa-add-card-btn cc" href="#"><span
														class="fa fa-shopping-cart cc"></span>加入購物車</a>
													<figcaption>
														<h4 class="aa-product-title">
															<a href="#">來一客</a>
														</h4>
														<span class="aa-product-price">$36.00</span><span
															class="aa-product-price"><del>$39.00</del></span>
													</figcaption>
												</figure>
											...
											<li>
												<figure>
													...
													<figcaption>
														...
														<span class="aa-product-price">$65.00</span><span
															class="aa-product-price"><del>$55.00</del></span>
													</figcaption>
												</figure>
												<div class="aa-product-hvr-content ii">
													<a href="#" data-toggle="tooltip" data-placement="top"
										...
										<a class="aa-browse-btn" href="#">所有商品 <span
									...
									<!-- 萊爾富 -->
									<!-- 萊爾富 -->
									<div class="tab-pane fade" style="padding-bottom: 35px"
										id="sports">
										<ul class="aa-product-catg">
											<!-- start single product item -->
											<li>
										...
										<a class="aa-browse-btn" href="#" style="margin-left: 520px;">所有商品
